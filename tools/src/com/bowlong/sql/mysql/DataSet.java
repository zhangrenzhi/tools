...
public class DataSet extends JdbcTemplate {
	...
	public List<Map> queryForList(String c, int begin, int num)
			throws SQLException {
		StringBuffer sb = StringBufPool.borrowObject();
		try {
			sb.append("SELECT * FROM ").append(TABLENAME);
	...
	public <T> List<T> queryForList(String c, Class c2, int begin, int num)
			throws Exception {
		StringBuffer sb = StringBufPool.borrowObject();
		try {
			sb.append("SELECT * FROM ").append(TABLENAME);
	...
	public List<Map> queryForList(int begin, int num) throws SQLException {
		return queryForList("", begin, num);
	}

	public <T> List<T> queryForList(Class c2, int begin, int num)
			throws Exception {
